...
{
    S3Status status;
    const char *hostname = "mtmss.com";//getenv("S3_HOSTNAME");
...
int main(int argc, char **argv)
{
    ...
    accessKeyIdG = "d9f1ead3e90c42af89841bcfa78fe628";//getenv("S3_ACCESS_KEY_ID");
    if (!accessKeyIdG) {
        fprintf(stderr, "Missing environment variable: S3_ACCESS_KEY_ID\n");
        return -1;
    }
    secretAccessKeyG = "474b801062b34061aaf4f9c3af0ae4df";//getenv("S3_SECRET_ACCESS_KEY");
    if (!secretAccessKeyG) {
        fprintf(stderr, 
